package pratices.abstraction.store;

import pratices.abstraction.store.product.ArtObject;
import pratices.abstraction.store.product.Furniture;
import pratices.abstraction.store.product.ProductForSale;
